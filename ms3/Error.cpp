...
namespace aid {
    Error::Error(const char* errorMessage) {
        if (errorMessage == nullptr) {
            ...
            msgAddress = new char[strlen(errorMessage)];
            strncpy(msgAddress, errorMessage, strlen(errorMessage));
    ...
    void Error::message(const char* str) {
        delete[] msgAddress;
        if ((str != nullptr)) {
            msgAddress = new char[strlen(str)];
            strncpy(msgAddress, str, strlen(str));
